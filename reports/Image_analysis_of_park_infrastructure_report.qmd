...
To assess data coverage, attribute fill rates were computed for each asset category. It was necessary to do this by asset category because not all attributes are relevant to all asset types (e.g., `Number of Steps` is only applicable to stairs). Invalid placeholder values were removed before computing fill rates.
